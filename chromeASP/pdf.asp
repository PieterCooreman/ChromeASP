...
select case filetype
	case "pdf" : command=command & " && chrome.exe --user-data-dir=" & chromeuserdatadir & " --headless --disable-gpu --no-pdf-header-footer --print-to-pdf-no-header --hide-scrollbars --disable-translate --virtual-time-budget=5000 --print-to-pdf=" & server.mappath(iFileN) & " " & link
